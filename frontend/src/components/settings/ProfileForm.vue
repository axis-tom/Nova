...
const emit = defineEmits(['update', 'change-email']);

const formRef = ref(null);
const submitting = ref(false);
const avatarInput = ref(null);
const avatarPreview = ref(props.profile.avatar || '');
...
watch(
  ...
  (newProfile) => {
    if (newProfile) {
      ...
      formData.company = newProfile.company || '';
      formData.title = newProfile.title || '';
