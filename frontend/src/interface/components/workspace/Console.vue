...
import GraphCanvas from '@/interface/components/console/GraphCanvas.vue'
import RunConsole from '@/interface/components/console/RunConsole.vue'
import TraceList from '@/interface/components/console/TraceList.vue'
import DebugTools from '@/interface/components/console/DebugTools.vue'
import TraceViewer from '@/interface/components/console/TraceViewer.vue'
import DebugPanel from '@/interface/components/console/DebugPanel.vue'
import TraceGraphIntegration from '@/interface/components/console/TraceGraphIntegration.vue'
import { listScenarios } from '@/api/graph'
import { ElMessage, ElMessageBox } from 'element-plus'

// 标签页状态
const activeTab = ref<string>('graph')
const rightPanelTab = ref<string>('status')

// Trace Viewer和Debug Panel状态
const traceViewerVisible = ref<boolean>(false)
const debugPanelVisible = ref<boolean>(false)
const selectedTraceId = ref<unknown | null>(null)

// 系统状态数据
const scenarioCount = ref<number>(0)
const totalNodes = ref<number>(0)
const todayExecutions = ref<number>(0)
