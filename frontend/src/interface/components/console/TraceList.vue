...
interface Emits {
  ...
  (e: 'filter', ...args: unknown[]): void
  (e: 'status-filter', ...args: unknown[]): void
  (e: 'view-details', ...args: unknown[]): void
  (e: 'clone', ...args: unknown[]): void
  (e: 'stop', ...args: unknown[]): void
  (e: 'page-size-change', ...args: unknown[]): void
  (e: 'page-change', ...args: unknown[]): void
}
