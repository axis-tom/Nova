...
const messages = ref<unknown[]>(6195)
const newMessage = ref<string>('')
const messagesContainer = ref<HTMLElement | null>(null)

// 树形数据
const treeData = ref<unknown[]>(6298)
const currentNodeKey = ref<HTMLElement | null>(null)

// 当前选中的项目/对话
const currentProject = ref<unknown | null>(null)
const currentConversation = ref<unknown | null>(null)

// 场景
const installedScenes = ref<unknown[]>(6467)
...
// 本地模型
const localModels = ref<unknown[]>(6817)
