...
from backend.memory.short_term.conversation_store import ConversationOut
from backend.communication.api.v1.auth import get_current_user          # 统一使用backend.communication.api.v1.auth中的依赖
